...
export async function GET() {
  ...
  try {
    ...
    return NextResponse.json({
      ...
      // Allowlist explícita: o objeto cru carrega passwordHash, chave PIX e
      // CPF/CNPJ. Esta rota só precisa identificar a funerária.
      funeralHomes: (data.funeralHomes || []).map((fh) => ({
        ...
        city: fh.city,
        state: fh.state,
        approvalStatus: fh.approvalStatus,
