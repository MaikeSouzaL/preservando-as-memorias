...
export async function POST(request: Request) {
  // Esta rota cria conta no Supabase Auth para o e-mail informado, sem prova de
  // posse. Sem limite, dá para pré-criar contas de terceiros em massa e impedir
  // que a pessoa se cadastre depois.
  const limited = await checkRateLimit(request as any, "rl:memorial-publico", {
    limit: 5,
    windowSecs: 60 * 60,
  });
