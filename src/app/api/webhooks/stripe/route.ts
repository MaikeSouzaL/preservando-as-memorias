...
async function handlePaymentConfirmed(session: Stripe.Checkout.Session) {
  ...
  // 2. Não há mais repasse automático.
  //
  // Antes, todo pagamento confirmado transferia 85% para a conta Stripe Connect
  // do "representante/operador". Esse papel foi extinto: o valor da venda ao
  // familiar é integralmente da plataforma, e a funerária é cobrada por
  // assinatura (`funeral_invoices`), não por fatia de cada venda.
