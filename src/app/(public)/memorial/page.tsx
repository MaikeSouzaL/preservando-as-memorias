...
export default function TransicaoQrPage() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      if (window.innerWidth < 768) {
        ...
        // Fade out gradually over the first 250px of scroll
  ...
  useEffect(() => {
    // Inicializa a instância do Howler uma única vez
    soundRef.current = new Howl({
      src: ['/audio/bg-music.mp3'],
      loop: true,
      volume: 0.6,
      html5: true, // Força uso de HTML5 audio (melhor para arquivos grandes como músicas)
      onloaderror: (id, err) => {
        console.error("Howler não conseguiu carregar o áudio. Verifique se o caminho /audio/bg-music.mp3 existe.", err);
      },
      onplayerror: (id, err) => {
        console.error("Howler erro ao tocar:", err);
    ...
    matchSoundRef.current = new Howl({
      ...
      volume: 1.0,
      html5: true,
      onloaderror: (id, err) => console.error("Erro carregar match-strike:", err),
      onplayerror: (id, err) => console.error("Erro tocar match-strike:", err)
    });
    ...
    heartbeatSoundRef.current = new Howl({
      ...
      onloaderror: (id, err) => console.error("Erro ao carregar heartbeat.mp3:", err),
      onplayerror: (id, err) => console.error("Erro ao tocar heartbeat.mp3:", err)
    });
  ...
  // Audio playback mute/unmute control effect
  useEffect(() => {
    if (soundRef.current) {
      if (isBgMuted) {
  ...
  // Fallback timer to show the memorial page after the loading animation duration
  useEffect(() => {
    if (showMemorial) return;
    ...
    return (
      <div className="relative flex h-dvh w-full flex-col items-center justify-center overflow-hidden bg-[#101414]">
        ...
        <div className="pointer-events-none absolute inset-0 z-0 h-full w-full">
          <img
            src="https://lh3.googleusercontent.com/aida/ADBb0ugVX9GSINffVdhZkGCvp4Ru4cwK3OZ46uflb_9bX1AAk9U6YWquv1eYy1QRXIFxNNpNCo7IpRlIXipeAV5j_fpadMKTfa3Q19zcMTxqXsid1o5Kp0gPnTh5_emBjYpHCbib0nKOCzf7M3gzqfG56brEjTfIkjbex_gJXmzK-hJH6QSI2-BBZ1tI_-jgWwNmM0vesvbo_QjtlUCUouejQVsq303K0U_XqBxrmpTJYFFLRbhjca2g_ANypKg"
            alt=""
        ...
        <div className="relative z-10 flex w-full max-w-[1200px] flex-col items-center px-8 text-center">
          {/* Loading neutro abstrato para evitar flashes e vazamento de João Henrique */}
          ...
          <div className="absolute bottom-[-100px] left-0 w-full text-center">
            <p className="font-label-caps text-[0.75rem] uppercase tracking-[0.15em] text-[#c4c7c7]/50">
  ...
  return (
    <div className="min-h-screen bg-[#101414] text-[#e0e3e2] antialiased overflow-x-hidden selection:bg-[#e9c349]/20 selection:text-[#e9c349]">
      ...
      {!showMemorial ? (
        ...
        <>
          ...
          <header className="fixed top-0 left-0 w-full z-50 bg-[#0b0f0f]/40 backdrop-blur-xl border-b border-[#e9c349]/10 shadow-[0_4px_30px_rgba(0,0,0,0.5)] flex justify-center md:justify-between items-center px-8 md:px-16 py-4 transition-all duration-300">
            <div className="flex flex-col md:flex-row items-center gap-2 md:gap-4 hover:opacity-90 transition-opacity">
              ...
              >
                <span className="material-symbols-outlined text-[0.95rem]">arrow_back</span>
                Landing
              </Link>
            </div>
            ...
            {/* Avatar removido (Página Pública) */}
          </header>
              ...
              <div className="md:col-span-8 flex flex-col justify-center bg-[#0b0f0f]/40 p-6 rounded-xl border border-white/5">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    <p className="text-xs text-[#c4c7c7] uppercase tracking-widest font-semibold mb-1">Áudio de Lembranças - Gravado em 2021</p>
                    <p className="text-xs text-[#c4c7c7]/50">Duração: 02:45 • Voz de {memorial.name}</p>
                  </div>
                </div>
          ...
          <section id="legacy" className="py-20 px-6 max-w-[1200px] mx-auto animate-fade-in" style={{ animationDelay: '3000ms', animationFillMode: 'both' }}>
            <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
              <div className="md:col-span-5 relative">
                ...
                <img
                  alt="Vintage photograph of youth"
                  className="w-full h-auto rounded-xl shadow-2xl filter grayscale opacity-80 border border-[#e9c349]/15"
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuBg_vgpJJyW8hKl8FJxjEG-F5ErhAPJ4Lsn7HFwJx8PUYoxj-myNebwG6r0CskS6me25PHCdeaGVU3vmtkO-7ycSRkOXCj9Oyo1u314GnCZJRlt5aO3rObAFo9m2C036jIVXlRKlw8283vidAwydQEqtCyXrwCscWVseDLMRgGppa6uinihhpG_wF-QWNCF1UPlKyS2qx9Ch3AOtorZT0ropBmuW5c1KOglgsGqOrj3jXNFIjnPXoG3V0lG1R7xHYg8zQzmbN82Etw"
                />
              </div>
          ...
          {/* Linha do Tempo de Memórias (Timeline of Memories) */}
          <section className="py-20 px-6 max-w-[1200px] mx-auto animate-fade-in relative" style={{ animationDelay: '3000ms', animationFillMode: 'both' }}>
                ...
                return (
                  <div key={event.id} className="relative flex flex-col md:flex-row items-start md:items-center w-full">
                    ...
                    <div className={`w-full md:w-1/2 flex ${isEven ? 'md:justify-end md:pr-16' : 'md:justify-start md:pl-16'}`}>
                      ...
                      >
                        {/* Mobile-only Description (Above Polaroid on mobile) */}
                        ...
                        <div className="bg-[#fcfbf9] p-4 pb-6 shadow-[0_10px_20px_rgba(0,0,0,0.3)] border border-[#e2dfd9] rounded-sm relative group overflow-hidden">
                          {/* Inner Shadow for photographic depth */}
                          ...
                          {/* Polaroid Bottom Label (Handwritten feel) */}
                    ...
                    {/* Espaçador Lado Oposto (Apenas Desktop) */}
          ...
          <section className="py-16 px-6 max-w-[1200px] mx-auto animate-fade-in" style={{ animationDelay: '3400ms', animationFillMode: 'both' }}>
            <div className="text-center mb-12">
              <h2 className="font-h2 text-2xl md:text-3xl text-[#e5e2e1]">Tributo em Vídeo</h2>
              <div className="h-[1px] w-16 bg-[#e9c349] mx-auto mt-4" />
            </div>
            <div className="relative aspect-video max-w-4xl mx-auto rounded-2xl overflow-hidden border border-[#e9c349]/15 shadow-2xl bg-[#0b0f0f]">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6">
                <button
                  onClick={() => alert("🎥 Reproduzindo tributo de homenagem familiar em vídeo. (Simulação de Player)")}
                  className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-[#e9c349]/10 border border-[#e9c349] hover:bg-[#e9c349] hover:text-[#101414] transition-all duration-500 flex items-center justify-center text-[#e9c349] shadow-2xl cursor-pointer group"
                >
                  <span className="material-symbols-outlined text-3xl md:text-4xl group-hover:scale-110 transition">play_arrow</span>
                </button>
                <p className="mt-6 text-sm font-label-caps uppercase tracking-[0.15em] text-[#e9c349]">Assistir Homenagem Cinematográfica</p>
                <p className="text-xs text-[#c4c7c7]/60 mt-1">Duração: 05:12 • Compilado pela Família Silva</p>
              </div>
            </div>
          </section>

          {/* 5. Linha do Tempo */}
          <section id="timeline" className="py-20 px-6 max-w-[1200px] mx-auto relative animate-fade-in" style={{ animationDelay: '3800ms', animationFillMode: 'both' }}>
            <div className="text-center mb-20">
              <h2 className="font-h2 text-3xl md:text-4xl text-[#e5e2e1]">Capítulos de uma Vida</h2>
              <div className="h-px w-24 bg-[#e9c349] mx-auto mt-4" />
            </div>

            <div className="relative timeline-line py-10">
              {/* Timeline Item 1 */}
              <div className="relative flex flex-col md:flex-row items-center justify-between mb-24 w-full">
                <div className="w-full md:w-5/12 text-center md:text-right md:pr-12 mb-6 md:mb-0">
                  <h3 className="font-h3 text-xl md:text-2xl text-[#e5e2e1] mb-2">O Início da Jornada</h3>
                  <p className="font-body-md text-sm text-[#c4c7c7] leading-relaxed">
                    O nascimento em uma manhã de primavera, trazendo esperança para a família Silva. O começo de um legado duradouro.
                  </p>
                </div>
                <div className="absolute left-1/2 transform -translate-x-1/2 flex-col items-center hidden md:flex">
                  <div className="w-4 h-4 rounded-full bg-[#e9c349] shadow-[0_0_15px_rgba(233,195,73,0.8)] z-10" />
                  <span className="font-label-caps text-[0.65rem] text-[#e9c349] mt-3 uppercase tracking-wider">1948</span>
                </div>
                <div className="w-full md:w-5/12 md:pl-12">
                  <div className="glass-panel p-2 rounded-xl border border-white/5 bg-[#1c2020]/20">
                    <img
                      alt="Old town street"
                      className="w-full h-40 md:h-48 object-cover rounded-lg filter grayscale"
                      src="https://lh3.googleusercontent.com/aida-public/AB6AXuD_GOgZfcHOsTUQCwrI8OmRu3K4c9AqFBQVJz-hSz9vqvrlCr_gRwCGkUmjbZi0zy3uLmV8Pe5XOLhkiXs3FOKclavxllVEYekl46Dcb_TsX6PGQiP0PureaQweDppoPob--qW0mERTauo_IPBmpEFwzauAeFkcFg3dhMwZ8Rq302LS_wBzGjik0w2an6CdwEwrbpqGlUmszl8Xexd9iovLrAzBuS8QiTfp-_sYOYbyMpGaGIdFR0vD_qnR2YBFTINECwfuH10jhDE"
                    />
                  </div>
                </div>
              </div>
              ...
              {/* Timeline Item 2 */}
              <div className="relative flex flex-col md:flex-row items-center justify-between mb-24 w-full md:flex-row-reverse">
                <div className="w-full md:w-5/12 text-center md:text-left md:pl-12 mb-6 md:mb-0">
                  <h3 className="font-h3 text-xl md:text-2xl text-[#e5e2e1] mb-2">O Encontro de Almas</h3>
                  <p className="font-body-md text-sm text-[#c4c7c7] leading-relaxed">
                    A união amorosa com Maria, o início de uma parceria inabalável que geraria frutos, sabedoria e perduraria por mais de cinco décadas.
                  </p>
                </div>
                <div className="absolute left-1/2 transform -translate-x-1/2 flex-col items-center hidden md:flex">
                  <div className="w-4 h-4 rounded-full bg-[#e9c349] shadow-[0_0_15px_rgba(233,195,73,0.8)] z-10" />
                  <span className="font-label-caps text-[0.65rem] text-[#e9c349] mt-3 uppercase tracking-wider">1972</span>
                </div>
                <div className="w-full md:w-5/12 md:pr-12">
                  <div className="glass-panel p-2 rounded-xl border border-white/5 bg-[#1c2020]/20">
                    <img
                      alt="Wedding hands"
                      className="w-full h-40 md:h-48 object-cover rounded-lg filter grayscale"
                      src="https://lh3.googleusercontent.com/aida-public/AB6AXuAgHjSuK3aMKCBJeYD9koMWA11OGNL7GlYzklGQSt610eIuhjoPaDAJA_oNEtassWJHHl2qtXPJN0LGt6vrI51zwuKRpKLCoNG3W4V5bNyLMY4ZuOzXogwZEphv-L6ZBHtCX57Fw4d6XLXUenvdunzVg8ZBEtJdBe3Xg-V09aSfK_cugiDM4nm-OJjVSRm_o39QxhS9JjcArLJdIl6z2oCXqycNxXq1yYlcLFbjtnXt89xH10Bp3YLysXaz895mcHRrupcDy2nvpsw"
                    />
                  </div>
                </div>
              </div>
          ...
          <section id="tributes" className="py-20 px-6 max-w-[1200px] mx-auto animate-fade-in" style={{ animationDelay: '4600ms', animationFillMode: 'both' }}>
            ...
            {/* Santuário de Velas com Brilho Dinâmico (Altar de Chamas Eternas) */}
              ...
              <div id="candle-altar" className="relative w-full max-w-5xl mx-auto pt-16 pb-8 px-4 sm:px-8 border-b-8 border-[#2a1f11] bg-gradient-to-t from-[#1a1208]/90 to-transparent rounded-t-xl shadow-[0_15px_40px_rgba(0,0,0,0.9)] overflow-hidden">
                ...
                <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
                  {Array.from({ length: 30 }).map((_, i) => {
                    const leftPercent = 3 + (i * 3.2); // Spreads 30 particles evenly across 3% to 96% of the altar width
                    const delay = -((i * 0.45) % 12); // Negative delay distributes particles from bottom to top instantly on load!
                    const duration = 6 + (i % 5) * 1.8; // 6s to 13.2s
                ...
                <div className="flex flex-col gap-y-12 items-center min-h-[140px] relative z-10">
                  {candlesList.length > 0 ? (
                    // Dividir as velas em prateleiras
                              ...
                              >
                                ...
                                <div className="relative flex flex-col justify-end items-center" style={{ height: '90px', width: '28px' }}>
                                  {!isExpired ? (
                                    ...
                                    <>
                                      {/* Fumaça apagada (Smoke for expired candle) - Apenas no 8º dia */}
                                      {ageInDays === 8 && (
                                        <div className="absolute left-[13px] w-[2px] h-0 z-20 pointer-events-none" style={{ bottom: `${heightPercent}%` }}>
                                          ...
                                          />
                                          <div 
                                            className="absolute bottom-1 -left-[2px] w-1.5 h-10 bg-gradient-to-t from-white/15 via-white/5 to-transparent rounded-full blur-[2.5px] animate-smoke" 
                                            style={{ transformOrigin: 'bottom center', animationDelay: '2s' }} 
                                          />
                                        </div>
                                      )}
                                      
                                      {/* Pavio Apagado (Burnt Wick) */}
                                      <div 
                                  ...
                                  >
                                    ...
                                    <div className="absolute top-0 left-0 w-full h-full overflow-hidden rounded-t-sm">
                                      ...
                                      {ageInDays > 1 && !candle.isEternal && <div className="absolute top-4 left-[6px] w-[2px] h-6 bg-[#fff8dc] rounded-full opacity-70" />}
                                    </div>
                                    {/* Topo derretido concavo */}
                                    <div className="absolute -top-[3px] left-0 w-full h-[6px] bg-[#fffacd] rounded-[50%] shadow-[0_2px_3px_rgba(0,0,0,0.3)_inset]" />
                                  </div>

                                  {/* Poça de cera na base (Base puddle) limitamos o tamanho pra não invadir as vizinhas */}
        ...
        {/* Tribute Modal (rendered outside the animated fade-in div to guarantee absolute viewport centering without scroll issues) */}
        {showTributeModal && (
        ...
        {/* Custom Success Modal (rendered outside the animated fade-in div to guarantee absolute viewport centering without scroll issues) */}
        {showCandleModal && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
                ...
                <div className="pt-8 flex flex-col sm:flex-row gap-3">
                  <button
                    onClick={() => {
                      ...
                      // Scroll beautifully down to the Altar
        ...
        {/* Floating Right-Side Audio Soundtrack Control Button */}
        {showMemorial && (
          <div 
