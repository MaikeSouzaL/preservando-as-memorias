  ...
  return (
    <label className="group relative block">
      ...
      <input
        ...
        onChange={onChange}
        required
        className="w-full border-0 border-b border-on-surface/40 bg-transparent py-3 pl-10 text-on-surface placeholder:text-on-surface-variant/50 focus:border-tertiary focus:outline-none focus:ring-0"
      />
    </label>
  );
}
