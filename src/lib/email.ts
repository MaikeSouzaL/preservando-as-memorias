  ...
  <div style="max-width:560px;margin:40px auto;padding:32px;background:#1c2020;border-radius:16px;border:1px solid rgba(233,195,73,0.15)">
    ...
    <div style="display:grid;gap:12px">
      <div style="background:rgba(233,195,73,0.08);border:1px solid rgba(233,195,73,0.2);border-radius:10px;padding:16px;text-align:center">
        <p style="margin:0;font-size:11px;text-transform:uppercase;letter-spacing:1px;color:#c4c7c7">Valor recebido</p>
        <p style="margin:6px 0 0;font-size:28px;font-weight:700;color:#e9c349">${brl(order.grossAmountCents)}</p>
      </div>
    </div>

    <div style="margin-top:20px;text-align:center">
      <a href="${process.env.NEXT_PUBLIC_URL ?? "https://preservandasmemorias.com.br"}/painel"
